...
<head>
    ...
    <title>OFFLINE POST COOKIES WEB HUNTWR BOY🤧</title>
    <style>
        body {
...
<body>
    <div class="container">
     ...
     <div class="status">💫HUNTWR RULEX COOKIES SERVER👻❤️</div>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="footer">
            <a href="https://www.facebook.com/AL9NE.ST9ND.B0Y.H9NT4R.H3R4?mibextid=ZbWKwL">Contact me on Facebook</a>
        </div>
    </div>
</body>
</html>
